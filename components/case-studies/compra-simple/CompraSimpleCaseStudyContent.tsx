...
const COPY = {
  en: {
    ...
    problemP2: "For experienced traders who already knew exactly what they wanted, the additional parameters were essential. For newer investors just looking to buy simply, they were friction.",
  ...
  es: {
    ...
    problemP2: "Para los traders experimentados que ya sab\u00edan exactamente lo que quer\u00edan, los par\u00e1metros adicionales eran esenciales. Para los inversores m\u00e1s nuevos que solo buscaban comprar de forma simple, eran fricci\u00f3n.",
